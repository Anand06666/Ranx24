...
import { FaHourglassHalf, FaClock, FaList } from "react-icons/fa";
import { useNavigate } from "react-router-dom";

const API_URL = "http://localhost:5000/api";

export default function WorkerTotalPending() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-[Poppins] px-5 py-10">
      <h1 className="text-3xl font-extrabold text-yellow-700 mb-8 border-b-4 border-yellow-400 inline-block pb-2">
        Pending Bookings
      </h1>
          ...
          {pendingBookings.map((b) => (
            ...
            >
              ...
              <div className="flex justify-between items-center mb-2">
                ...
                {/* Status Badge */}
                <span className="px-3 py-1 text-xs font-semibold rounded-full flex items-center gap-1 bg-yellow-100 text-yellow-700">
              ...
              <button
                ...
                className="mt-5 w-full bg-yellow-600 text-white py-2 rounded-lg font-semibold hover:bg-yellow-700 transition"
              >
                View Details
              </button>
            </div>
